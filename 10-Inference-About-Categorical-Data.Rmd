...
The conclusion of the test should always be stated in the context of the problem.

For example, if we reject

$$
H_0:p=0.50,
$$

we should not stop at saying “reject $H_0$.” Instead, we should say something like:

> The data provide evidence that the population proportion differs from 50%.

Or, if the alternative is one-sided,

> The data provide evidence that the population proportion is greater than 50%.

This is the same principle used throughout inference: the statistical conclusion must be translated back into the scientific or practical question.
